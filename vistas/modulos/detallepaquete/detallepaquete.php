            ...
            <div class="col-lg-12">
              ...
              <div id="productMain" class="row">
                <div class="col-sm-6">
                  ...
                  <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-795px, 0px, 0px); transition: 0.25s; width: 1193px;"><div class="owl-item" style="width: 397.5px;"><div> <img src="i../../vistas/assets/img/catalogo_tours/1-b.jpg" alt="" class="img-fluid"></div></div><div class="owl-item" style="width: 397.5px;"><div> <img src="i../../vistas/assets/img/catalogo_tours/2-b.jpg" alt="" class="img-fluid"></div></div><div class="owl-item active" style="width: 397.5px;"><div> <img src="i../../vistas/assets/img/catalogo_tours/3-b.jpg" alt="" class="img-fluid"></div></div></div></div><div class="owl-nav disabled"><button type="button" role="presentation" class="owl-prev"><span aria-label="Previous">‹</span></button><button type="button" role="presentation" class="owl-next"><span aria-label="Next">›</span></button></div><div class="owl-dots disabled"></div></div>
                </div>
                <div class="col-sm-6">
                  <div class="box">
                    <form>
                  ...
                  <div data-slider-id="1" class="owl-thumbs">
                    <button class="owl-thumb-item"><img src="i../../vistas/assets/img/catalogo_tours/1-b-sm.png" alt="" class="img-fluid"></button>
                    <button class="owl-thumb-item"><img src="i../../vistas/assets/img/catalogo_tours/2-b-sm.png" alt="" class="img-fluid"></button>
                    <button class="owl-thumb-item active"><img src="i../../vistas/assets/img/catalogo_tours/3-b-sm.png" alt="" class="img-fluid"></button>
                  </div>
                </div>
              </div>
