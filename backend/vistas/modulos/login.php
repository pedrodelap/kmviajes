                        ...
                        <div class="slick-slider">
                            <div>
                                <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-plum-plate"
                                    ...
                                    <div class="slide-img-bg"
                                        style="background-image: url('vistas/assets/images/originals/city2.jpg');">
                                    </div>
                            ...
                            <div>
                                <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark"
                                    tabindex="-1">
                                    <div class="slide-img-bg"
                                        style="background-image: url('vistas/assets/images/originals/citynights.jpg');">
                                    </div>
                                    <div class="slider-content">
                            ...
                            <div>
                                <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-sunny-morning"
                                    tabindex="-1">
                                    <div class="slide-img-bg"
                                        style="background-image: url('vistas/assets/images/originals/citydark.jpg');">
                                    </div>
                                    <div class="slider-content">
                    ...
                    <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                        ...
                        <div>
                            <form method="post">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group"><label for="ingUsuario"
                                                class="">Usuario</label><input name="ingUsuario" id="ingUsuario"
                                                placeholder="Email here..." type="text" class="form-control"
                                                value="kmpio"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="position-relative form-group"><label for="ingPassword"
                                                class="">Contraseña</label><input name="ingPassword" id="ingPassword"
                                ...
                                <div class="position-relative form-check"><input name="check" id="exampleCheck"
                                        ...
                                        class="form-check-label">Recordar contraseña </label></div>
                                <div class="divider row"></div>
                                <div class="d-flex align-items-center">
                                    <div class="ml-auto"><a href="#" class="btn-lg btn btn-link">Recuperar contraseña
                                        </a>
                                        <button type="submit" class="btn btn-primary btn-lg">Ingresar al Dashboard
                                        </button>
                                    </div>
                                </div>
                            </form>
