...
$(".leerMensaje").click(function() {
    ...
    nombre = $("#" + id).children("h5").html();
    email = $("#" + id).children("h6").html();
    mensaje = $("#" + id).children("h6").children("input").val();

    $("#visorMensajes").html('<div class="well well-sm"><h3>' + nombre + '</h3><h5>' + email + '</h5><p style="background:#fff; padding:10px">' + mensaje + '</p><button class="btn btn-info btn-sm responderMensaje">Responder</button><br><br><li class="nav-item-divider nav-item"></li></div>');
