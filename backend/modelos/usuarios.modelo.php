...
class ModeloUsuarios{
	...
	static public function mdlEditarUsuario($tabla, $datos){
		...
		UPDATE $tabla SET nombres = :nombres, apellidos = :apellidos, usuario = :usuario, password = :password, perfil = :perfil, fecha = 'NOW()', tipo_documento = :tipo_documento, numero_documento = :numero_documento, telefono = :telefono, correo = :correo, foto = :foto WHERE id_usuario = :id_usuario");
